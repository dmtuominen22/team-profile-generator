...
<link rel="stylesheet" href="../temp/style.css">
    ...
    for (const card of employeeArray) {
        htmlData += `<div class="card mx-auto" style="width: 18rem">
    ...
    <ul class="list-group list-group-flush">
        ...
        switch (card.getRole()) {
            case "Engineer":
                htmlData += `<li class="list-group-item">GitHub: ${card.getGithub()}</li>`;
                break;
            case "Intern":
                htmlData += `<li class="list-group-item">GitHub: ${card.getSchool()}</li>`;
                break;
            case "Manager":
                htmlData += `<li class="list-group-item">GitHub: ${card.getOfficeNumber()}</li>`;
                break;
        }
        htmlData += "</ul></div>";
    }
